            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
                <div className="flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex space-x-10 text-lg">
                        ...
                        <a href="/LinhaSOU" className="hover:text-gray-300 transition-all">SOU</a>
                ...
                <div id="mobile-menu" className="md:hidden mt-5 hidden space-y-4">
                    ...
                    <a href="/LinhaSOU" className="block text-lg hover:text-gray-300 transition-all">SOU</a>
...
export default TerceiroCabecalho;