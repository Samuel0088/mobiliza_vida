          ...
          <div className="mt-8 flex flex-col items-center">
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-gray-600">
                ...
                <Link
                  to="/cadastro"
                  className="text-blue-500 hover:underline border-blue-500 border-dotted mt-1"
                >
                  Cadastre-se aqui
                </Link>
              </p>
          ...
          <div className="m-12 xl:m-16 w-full flex items-center justify-center">
            <div className="text-white text-center">
              <h2 className="text-4xl font-bold mb-4">
                Mobiliza <span className="text-teal-300">Vida</span>
              </h2>
              <p className="text-xl opacity-90">
                Conectando pessoas, movendo cidades
              </p>
